...
std::string getToken(const std::string& addr, const std::string& room_id, const std::string& isp, const std::string& region, bool verify_peer, const std::string& role);
